      ...
      <div class="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        <div class="max-w-3xl">
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            ...
            <NuxtLink v-if="!authStore.isAuthenticated" to="/auth/register" class="btn-outline border-white text-white hover:bg-white/10">
              Become a Creator
            </NuxtLink>
        ...
        <div class="lg:flex lg:items-center lg:justify-between">
          ...
          <div class="mt-8 lg:mt-0 lg:flex-shrink-0">
            <div class="flex flex-col sm:flex-row gap-4">
              ...
              <NuxtLink to="/how-it-works" class="btn-outline border-white text-white hover:bg-white/10">
                Learn More
              </NuxtLink>
            </div>
          </div>
...
// Fetch featured creators on component mount
onMounted(async () => {
  if (subscriptionStore.creators.length === 0) {
    await subscriptionStore.fetchCreators();
  }
});

// Get featured creators from the store
const featuredCreators = computed(() => {
  return subscriptionStore.getTopCreators(3);
});
